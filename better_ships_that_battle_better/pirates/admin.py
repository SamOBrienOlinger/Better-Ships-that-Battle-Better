...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = [
        'pirate_name', 'user', 'chosen_pirate_queen',
        'preferred_difficulty', 'total_games', 'win_percentage'
    ]
    list_filter = ['preferred_difficulty', 'chosen_pirate_queen', 'created_at']
    search_fields = ['pirate_name', 'user__username', 'user__email']
    readonly_fields = [
        'created_at', 'updated_at', 'total_games',
...
class GameAdmin(admin.ModelAdmin):
    list_display = [
        'player', 'result', 'shots_fired',
        'ships_sunk', 'difficulty', 'played_at'
    ]
